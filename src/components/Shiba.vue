      ...
      >
        ...
        <defs>
          <radialGradient
            ...
            cy="57.11"
            r="6.94"
            gradientTransform="translate(3.23 14.14) rotate(4.8) scale(1 0.6)"
          ...
          <radialGradient
            ...
            cy="57.11"
            r="6.94"
            gradientTransform="translate(77.16 7.47) rotate(85.2) scale(1 0.6)"
            xlink:href="#cheeks"
          />
        </defs>
        <g id="body">
          ...
          <g id="base">
            ...
            <path
              id="top1"
              class="outline"
              d="M96.39,16.92A54.83,54.83,0,0,0,74,13.51a60.87,60.87,0,0,0-27.55,8"
            />
            <path
              id="top2"
              class="outline"
              d="M100.66,18.27a55,55,0,0,0-22.07-4.92,60.86,60.86,0,0,0-28,6"
            />
            <path
              id="top3"
              class="outline"
              d="M114.34,27.53a58.1,58.1,0,0,0-70.89-4.08"
            />
          </g>
          <g id="cheeks">
            <ellipse
          ...
          <g id="snout">
            ...
            <g id="mouth2">
              ...
              <path
                class="outline"
                d="M67,64.64c2.39,3.83,6.17,6.21,9,6.21s6-1.66,9.07-6.21"
              />
            </g>
            <g id="mouth3">
              <path
              ...
              <path
                class="outline"
                d="M68.81,64.64c0,4.54,4.4,9.09,7.26,9.09s7.27-4.55,7.27-9.09"
              />
            </g>
            <g id="mouth4">
              <path
              ...
              <path
                class="outline"
                d="M68.78,64.44A9.61,9.61,0,0,0,76,68c4.42,0,7.35-3.59,7.35-3.59"
              />
            </g>
            <g id="mouth5">
              <path
            ...
            <path
              class="nose"
              d="M82,52c0,1.69-2.32,4.06-6,4.06-3.52,0-6-2.34-6-4,0-2,4-2.73,6-2.73S82,50.15,82,52Z"
            />
            <g id="lips">
              <path
                class="outline"
            ...
            <g id="mouth6">
              ...
              <path
                class="outline thin"
                d="M83.23,65.33a19.08,19.08,0,0,0,1.18-4.6"
              />
            </g>
          </g>
          <g id="eyes">
            ...
            <g id="wink">
              <path
                class="left eye outline"
                d="M51,45.45a24.91,24.91,0,0,1,9,1.7,26.15,26.15,0,0,0-8.71-2.49"
              />
              <path
                class="right eye outline"
                d="M100.56,45.45a24.94,24.94,0,0,0-9,1.7,26.15,26.15,0,0,1,8.71-2.49"
              />
            </g>
            <g id="laugh">
              <path
                class="left eye outline"
                d="M49.61,48.82A32.19,32.19,0,0,1,59,48a26,26,0,0,0-8-4.15"
              />
              <path
                class="right eye outline"
                d="M102.07,48.82A32.19,32.19,0,0,0,92.71,48a26,26,0,0,1,8.05-4.15"
              />
            </g>
            <g id="shy">
              <path
                class="left eye outline"
                d="M51,47a12.34,12.34,0,0,1,9.09-1.33,14.65,14.65,0,0,0-9,.49"
              />
              <path
                class="right eye outline"
                d="M100.34,46.92a13.6,13.6,0,0,0-9.09-1.33,16.26,16.26,0,0,1,9,.49"
              />
            </g>
          </g>
          <g id="brows">
...
export default defineComponent({
  ...
  setup(props) {
    const ears = computed(() => {
      ...
      if (props.leftEar === "up") {
        l = "l1";
      } else if (props.leftEar === "down") {
        l = "l3";
      } else if (props.leftEar === "flat") {
        l = "l2";
      }
      if (props.rightEar === "up") {
        r = "r1";
      } else if (props.rightEar === "down") {
        r = "r3";
      } else if (props.rightEar === "flat") {
        r = "r2";
      }
      return `/ ears ${l} ${r}`;
    });
    const eyes = computed(() => {
      if (props.leftEye === props.rightEye) {
        return `/ eyes ${props.leftEye}`;
      } else {
        return `/ eyes l${props.leftEye} r${props.rightEye}`;
      }
    });
    const cheeks = computed(() => {
      return props.blush ? "/ blush" : "";
    });
    const styleClass = computed(() => {
      return `${props.size} / ${props.mood} ${eyes.value} ${ears.value} ${cheeks.value}`;
    });
    return {
      styleClass,
    };
...
.MochiShiba.ears.l1.r1 #base #top2,
.MochiShiba.ears.l4.r4 #base #outline2,
.MochiShiba.ears.l4.r4 #base #top2 {
  visibility: visible;
}
.MochiShiba.ears.l1.r2 #base #outline1,
.MochiShiba.ears.l1.r2 #base #top2,
.MochiShiba.ears.l1.r4 #base #outline1,
...
.MochiShiba.ears.l2.r1 #base #top1,
.MochiShiba.ears.l4.r1 #base #outline1,
.MochiShiba.ears.l4.r1 #base #top1 {
  visibility: visible;
}
.MochiShiba.ears.l2.r2 #base #outline1,
.MochiShiba.ears.l2.r2 #base #top2,
.MochiShiba.ears.l4.r2 #base #outline1,
.MochiShiba.ears.l4.r2 #base #top2,
.MochiShiba.ears.l2.r4 #base #outline1,
.MochiShiba.ears.l2.r4 #base #top2 {
  visibility: visible;
}
.MochiShiba.ears.l2.r3 #base #outline3,
.MochiShiba.ears.l2.r3 #base #top3,
.MochiShiba.ears.l4.r3 #base #outline3,
...
.MochiShiba.eyes.open #open .eye.left,
.MochiShiba.eyes.lopen #open .eye.left {
  visibility: visible;
}
.MochiShiba.eyes.open #open .eye.right,
.MochiShiba.eyes.ropen #open .eye.right {
  visibility: visible;
}
.MochiShiba.eyes.wink #wink .eye.left,
.MochiShiba.eyes.lwink #wink .eye.left {
  visibility: visible;
}
.MochiShiba.eyes.wink #wink .eye.right,
.MochiShiba.eyes.rwink #wink .eye.right {
  visibility: visible;
}
.MochiShiba.eyes.laugh #laugh .eye.left,
.MochiShiba.eyes.llaugh #laugh .eye.left {
  visibility: visible;
}
.MochiShiba.eyes.laugh #laugh .eye.right,
.MochiShiba.eyes.rlaugh #laugh .eye.right {
  visibility: visible;
}
.MochiShiba.eyes.shy #shy .eye.left,
.MochiShiba.eyes.lshy #shy .eye.left {
  visibility: visible;
}
.MochiShiba.eyes.shy #shy .eye.right,
.MochiShiba.eyes.rshy #shy .eye.right {
  visibility: visible;
}
.MochiShiba.eyes.open.gleam #open .gleam,
.MochiShiba.eyes.lopen.gleam #open .gleam.left {
  visibility: visible;
}
...
.MochiBox.pop .paws,
.MochiBox:hover .paws,
.MochiBox:active .paws,
.MochiBox:focus .paws {
  -webkit-animation: paw-pop 0.3s ease 1 both;
  animation: paw-pop 0.3s ease 1 both;
}
.MochiBox.pop .shiba,
.MochiBox:hover .shiba,
.MochiBox:active .shiba,
.MochiBox:focus .shiba {
  -webkit-animation: shiba-pop 1s ease 1 both;
  animation: shiba-pop 1s ease 1 both;
}
.MochiBox.pop .eyes.open:not(.cheeky):not(.gleam) [id^="mouth"],
.MochiBox:hover .eyes.open:not(.cheeky):not(.gleam) [id^="mouth"],
.MochiBox:active .eyes.open:not(.cheeky):not(.gleam) [id^="mouth"],
.MochiBox:focus .eyes.open:not(.cheeky):not(.gleam) [id^="mouth"] {
  -webkit-animation: shiba-wink-open 10s infinite linear both;
  animation: shiba-wink-open 10s infinite linear both;
}
.MochiBox.pop .eyes.open:not(.cheeky):not(.gleam) #mouth6,
.MochiBox:hover .eyes.open:not(.cheeky):not(.gleam) #mouth6,
.MochiBox:active .eyes.open:not(.cheeky):not(.gleam) #mouth6,
.MochiBox:focus .eyes.open:not(.cheeky):not(.gleam) #mouth6 {
  visibility: visible;
  -webkit-animation: shiba-wink-closed 10s infinite linear both;
  animation: shiba-wink-closed 10s infinite linear both;
}
.MochiBox.pop .eyes.open:not(.cheeky):not(.gleam) #open .left,
.MochiBox:hover .eyes.open:not(.cheeky):not(.gleam) #open .left,
.MochiBox:active .eyes.open:not(.cheeky):not(.gleam) #open .left,
.MochiBox:focus .eyes.open:not(.cheeky):not(.gleam) #open .left {
  -webkit-animation: shiba-wink-open 10s infinite linear both;
  animation: shiba-wink-open 10s infinite linear both;
}
.MochiBox.pop .eyes.open:not(.cheeky):not(.gleam) #wink .eye.left,
.MochiBox:hover .eyes.open:not(.cheeky):not(.gleam) #wink .eye.left,
.MochiBox:active .eyes.open:not(.cheeky):not(.gleam) #wink .eye.left,
.MochiBox:focus .eyes.open:not(.cheeky):not(.gleam) #wink .eye.left {
  visibility: visible;
  -webkit-animation: shiba-wink-closed 10s infinite linear both;
  animation: shiba-wink-closed 10s infinite linear both;
}
